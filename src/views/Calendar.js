  ...
  editorTemplate(props) {
    return (props !== undefined ? <table className="custom-event-editor" style={{ width: '100%', cellpadding: '5' }}><tbody>
      ...
      <tr><td className="e-textlabel">Vessel Name</td><td colSpan={4}>
        <DropDownListComponent id="EventType" placeholder='Choose status' data-name="EventType" className="e-field" style={{ width: '100%' }} dataSource={['Adventurer', 'Advantage summer', 'Advantage']} value={props.EventType || null}></DropDownListComponent>
      </td></tr>
