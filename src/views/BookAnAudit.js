    ...
    <div className="content">
      ...
      <Row>
        <Col className="ml-auto mr-auto" md="12">
          <div class="bookauditcard">
            <Card className="card-calendar">
              <div class="bookauditheader">
                <CardHeader class="bookauditheader">
                  <h4 class="cardTitleWhite">BOOK AN AUDIT</h4>
                  {/* <p class ="cardCategoryWhite">Complete your profile</p> */}
                </CardHeader>
              </div>
              <CardBody>
                <form class="bookaudittable" onSubmit={submitHandler}>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        ...
                        >
                          ...
                          <option value="GH CITATION">GH CITATION</option>
