...
import { Card, CardHeader, CardBody, CardTitle, Row, Col, DropdownToggle, UncontrolledDropdown,
    Container,NavbarBrand,Nav,
    DropdownMenu,
...
function VesselStatementHistoryTab() {
    ...
    return (
        <div>
            ...
            <div style={{padding:"10px"}}>
                {/* <div  style={{width:"200px",marginLeft:"850px",marginBottom:"-40px"}}> */}
                {/* <Container style={{display:"flex",justifyContent:"right"}}>
                <label for="cars" style={{fontSize:"17px",marginRight:"8px"}}>Select For Last: </label>
                  <Collapse isOpen={collapseOpen} navbar  style={{borderRadius:"20px",
                  border: "aliceblue",backgroundColor: "white",marginTop: "-7px",fontSize:"16px"}}>
                    <Nav navbar>
                      <UncontrolledDropdown nav>
                        ...
                        <DropdownMenu style={{marginLeft:"-100px"}}>
                ...
                <div style={{display:"flex",justifyContent:"right",marginBottom:"-39px"}}>
                 {/* <div className="col-sm-4"> */}
                 <label for="cars" style={{fontSize:"17px",marginRight:"8px"}}>Select For Last: </label>
                        <select
                          className="form-control"style={{width:"150px", zIndex:"1"}}
                    ...
                    <option value="6">30 years</option>
                        </select>
                      {/* </div> */}
                      </div>
            ...
            <Tabs type="card">
                <TabPane tab="MSC" key="1" style={{ backgroundColor: "#ffff",marginRight: "155px" }}> 
                <Card style={cardcss}>
            ...
            <div style={subtypetextcss}>SDR</div></Card>
                ...
                >
                    ...
                    <AccordionDetails>
                        <Card style={{ width: "100%" }}>
                            ...
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">ISM</p>                            
                            <Table
                                columns={columnsHistory}
                ...
                >
                    ...
                    <AccordionDetails>
                        <Card style={{ width: "100%" }}>
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">ASI</p>                           
                            <Table
                                columns={columnsHistory}
                                dataSource={dataHistoryASI}
                                size="small"
                ...
                >
                    ...
                    <AccordionDetails>
                        <Card style={{ width: "100%" }}>
                            ...
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">IHM</p>
                            <Table
                                columns={columnsHistory}
                                dataSource={dataHistoryIHM}
                                size="small"
                            ...
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">SOPEP </p>
                            <Table
                                columns={columnsHistory}
                                dataSource={dataHistorySOPEP}
                                size="small"
                            ...
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">STS </p>
                            <Table
                                columns={columnsHistory}
                                dataSource={dataHistorySTS}
                                size="small"
                            ...
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">SMPEP </p>
                            <Table
                                columns={columnsHistory}
                                dataSource={dataHistorySMPEP}
                                size="small"
                            ...
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">BWS </p>                            
                            <Table
                                columns={columnsHistory}
                                dataSource={dataHistoryBWS}
                                size="small"
                            ...
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">VOC </p>                            
                            <Table
                                columns={columnsHistory}
                                dataSource={dataHistoryVOC}
                                size="small"
                            ...
                            <p style={{ fontWeight: "bold", marginLeft: "10px", marginTop: "-10px" }}align="left">SWR </p>                            
                            <Table
                                columns={columnsHistory}
                                dataSource={dataHistorySWR}
                                size="small"
...
export default VesselStatementHistoryTab
