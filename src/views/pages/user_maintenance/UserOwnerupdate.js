...
import { Button, Radio, notification, Select,Table } from "antd";
    ...
    return (
        <div className="content">
            <Card>
                <div className="right">
                    <Tabs type="card">
                        <TabPane tab="USERS LIST" key="1" style={{ backgroundColor: "#ffff " }}>
                            <MaterialTable
                                style={{
                                ...
                                columns={[
                                    ...
                                    { title: "COMAPNY NAME", field: "designation" },
                                    {
                                ...
                                data={[
                                    ...
                                    },
                                    {
                                        ...
                                        lastname: "Moutafis",
                                        auditorname: "Vernier, Switzerland",
                                        designation: "TRANSOCEAN OFFSHORE DEEPWATER DRILLING INC.",
                                        vessels: 3,
                                        auditsOverDue: 0,
                                        auditsDue: 0,
                                        findingsOverDue: 5,
                                    ...
                                    },
                                    {
                                        ...
                                        auditorname: "Cayman Island",
                                        designation: "ABC Maritime AG",
                                        vessels: 5,
                                        auditsOverDue: 0,
                                        auditsDue: 0,
                                        findingsOverDue: 5,
                                    ...
                                    },
                                    {
                                        firstname: "Anil ",
                                        lastname: "Jain",
                                        auditorname: "United Kingdom",
                                        designation: "A&L CF June(3) Limited",
                                        vessels: 5,
                                        auditsOverDue: 0,
                                        auditsDue: 0,
                                        findingsOverDue: 5,
                        ...
                        <TabPane tab="CREATE USER" key="2" style={{ backgroundColor: "#ffff " }}>
                            {/* <Card> */}
                            ...
                            <div className="userMaintenanceCard">
                                <div>
                                    {localStorage.getItem("role") == "company" ?
                                        ...
                                        /> : <Input
                                            value="TRANSOCEAN OFFSHORE DEEPWATER DRILLING INC."
                                            onChange={handleCompanyImoChange}
                                            size="large"
                                            placeholder="Company"
                                            readOnly
                                ...
                                <div>
                                    {localStorage.getItem("role") == "company" ?
                                        <Tooltip title={companyAddress}>
                                            ...
                                            />
                                        </Tooltip> : <Tooltip title={companyAddress}>
                                            <Input
                                ...
                                <div>
                                    {localStorage.getItem("role") == "owner1" ?
                                        ...
                                        >
                                            <Option value="4 YOU">DEEPWATER SKYROS</Option>
                                            <Option value="FEDERAL ASAHI">DEEPWATER PROTEUS</Option>
                                            <Option value="ADVANTAGE SKY">DEEPWATER POSEIDON</Option>
                                            <Option value="BLUE EVERTON">DHIRUBHAI DEEPWATER KG2</Option>
                                            <Option value="SCOUT II">DEEPWATER PONTUS</Option>
                                        </Select>
                                        :
                                        <Select
                                            showSearch
                                        ...
                                        >
                                            <Option value="4 YOU">FEDERAL TAMBO</Option>
                                            <Option value="FEDERAL ASAHI">BALTIC LEOPARD</Option>
                                            <Option value="ADVANTAGE SKY">NAVIGARE BACCA</Option>
                                            <Option value="BLUE EVERTON">SEAMAX FAIRFIELD</Option>
                                            <Option value="SCOUT II">SEAMAX WESTPORT</Option>
                                        </Select>}
                                </div>
                            </div>
...
export default UserOwnerupdate;
