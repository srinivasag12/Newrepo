...
const columns = [
  ...
  },
  {
    ...
    customRender: true,
    render: (showPopover) => {
      return <MoreOutlined onClick={(e) => showPopover(e)} />;
    },
  },
  // {
  //   id: "dpa",
...
const CompanyDetailsRetrieveModal = ({ setModalOpen, modalState }) => {
  ...
  const open = Boolean(popoverProps.anchorEl);
  ...
  const showMoreInfo = (ev, props) => {
    setPopoverProps({ props: props, anchorEl: ev.currentTarget });
    console.log(props);
  };
  const onColumnSelect = (column) => {
    console.log(column.imoNumber);
  };
  return (
    <Modal
    ...
    >
      {/* <Fade in={modalState}> */}
      <Box style={{ backgroundColor: "white", borderRadius: "1rem" }}>
        <Grid
          sx={{
            display: "fles",
        ...
        >
          ...
          <Grid>
            <OutlinedInput
              placeholder="Search..."
              size="small"
              sx={{ borderRadius: "15rem", height: "2rem" }}
            />
            {/* <CloseIcon onClick={() => setModalOpen(false)} /> */}
          </Grid>
        </Grid>

        <Paper sx={{ width: "100%", overflow: "hidden", padding: "1em" }}>
        ...
        >
          {companyList.map((res) => {
            return res.imoNumber === popoverProps.props.vesselImoNo ? (
              <Card>
                <CloseIcon
                  sx={{
                    height: "1rem",
                ...
                <CardContent>
                  <Box style={{ fontSize: "12px", fontWeight: "600" }}>
                    <Grid sx={{ paddingBottom: "1rem" }}>
                      <CircleIcon
                        sx={{ width: "1rem", height: "1rem", color: "#467199" }}
                      />
                      <span style={{ color: "#9a9a9a" }}> OFFICIAL ID :</span>{" "}
                      <span>{res.officialId} </span>
                    </Grid>
                    <Grid sx={{ paddingBottom: "1rem" }}>
                      <CircleIcon
                        sx={{ width: "1rem", height: "1rem", color: "#467199" }}
                      />
                      <span style={{ color: "#9a9a9a" }}> DPA : </span>{" "}
                      <span>{res.dpa} </span>
                    </Grid>
                    <Grid sx={{ paddingBottom: "1rem" }}>
                      <CircleIcon
                        sx={{ width: "1rem", height: "1rem", color: "#467199" }}
                      />
                      <span style={{ color: "#9a9a9a" }}> DCO ISSUER : </span>
                      <span>{res.docIssuer} </span>
                    </Grid>
                    <Grid sx={{ paddingBottom: "1rem" }}>
                      <CircleIcon
                        sx={{ width: "1rem", height: "1rem", color: "#467199" }}
                      />
                      <span style={{ color: "#9a9a9a" }}> BUILDER : </span>{" "}
                      <span>{res.Builder} </span>
                    </Grid>
                  </Box>
                </CardContent>
              </Card>
...
export default CompanyDetailsRetrieveModal;
