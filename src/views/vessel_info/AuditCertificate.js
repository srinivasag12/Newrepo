...
function AuditCertificate() {
  ...
  const dataActive = [
    {
      key: "1",
      audit_type: <Tag color="purple">ISM</Tag>,
      issued_place: (
  ...
  const dataActiveISPS = [
    {
      key: "1",
      audit_type: <Tag color="purple">ISPS</Tag>,
      issued_place: (
        <p style={{ fontSize: "Medium" }}>
          <i class="fa fa-map-marker" style={{ color: "red" }}>
            <span class="fix-editor">&nbsp;</span>
